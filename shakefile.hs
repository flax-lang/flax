...
flaxcNormFlags		= "-Wno-unused-variable -sysroot " ++ sysroot ++ " -no-lowercase-builtin -o '" ++ compiledTest ++ "'"
flaxcJitFlags		= "-Wno-unused-variable -sysroot " ++ sysroot ++ " -no-lowercase-builtin -run"

...
namespace Operators
{
	struct OperatorMap
	{
		using OperatorFunc = Ast::Result_t(*)(Codegen::CodegenInstance*, Ast::ArithmeticOp,
			Ast::Expr*, std::vector<Ast::Expr*>);
		std::map<Ast::ArithmeticOp, OperatorFunc> theMap;

		OperatorMap();
		Ast::Result_t call(Ast::ArithmeticOp op, Codegen::CodegenInstance* cgi, Ast::Expr* usr, std::vector<Ast::Expr*> args);

		static OperatorMap& get();
	};


	Ast::Result_t operatorCustom(Codegen::CodegenInstance* cgi, Ast::ArithmeticOp op, Ast::Expr* usr, std::vector<Ast::Expr*> args);
	...
	Ast::Result_t operatorLogicalOr(Codegen::CodegenInstance* cgi, Ast::ArithmeticOp op, Ast::Expr* usr, std::vector<Ast::Expr*> args);

	Ast::Result_t operatorBitwiseNot(Codegen::CodegenInstance* cgi, Ast::ArithmeticOp op, Ast::Expr* usr, std::vector<Ast::Expr*> args);
	Ast::Result_t operatorUnaryPlus(Codegen::CodegenInstance* cgi, Ast::ArithmeticOp op, Ast::Expr* usr, std::vector<Ast::Expr*> args);
	Ast::Result_t operatorUnaryMinus(Codegen::CodegenInstance* cgi, Ast::ArithmeticOp op, Ast::Expr* usr, std::vector<Ast::Expr*> args);
	Ast::Result_t operatorAddressOf(Codegen::CodegenInstance* cgi, Ast::ArithmeticOp op, Ast::Expr* usr, std::vector<Ast::Expr*> args);
	Ast::Result_t operatorDereference(Codegen::CodegenInstance* cgi, Ast::ArithmeticOp op, Ast::Expr* usr, std::vector<Ast::Expr*> args);
	...
	Ast::Result_t operatorOverloadedSubscript(Codegen::CodegenInstance* cgi, Ast::ArithmeticOp op, Ast::Expr* usr, std::vector<Ast::Expr*> args);
	...
	fir::Function* getOperatorSubscriptGetter(Codegen::CodegenInstance* cgi, Ast::Expr* user, fir::Type* cls, std::vector<Ast::Expr*> args);
}

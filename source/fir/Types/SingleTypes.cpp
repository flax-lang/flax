...
namespace fir
{
	...
	fir::Type* AnyType::substitutePlaceholders(const ska::flat_hash_map<fir::Type*, fir::Type*>& subst)     { return this; }
	...
	fir::Type* BoolType::substitutePlaceholders(const ska::flat_hash_map<fir::Type*, fir::Type*>& subst)    { return this; }
	...
	fir::Type* VoidType::substitutePlaceholders(const ska::flat_hash_map<fir::Type*, fir::Type*>& subst)    { return this; }
	...
	fir::Type* NullType::substitutePlaceholders(const ska::flat_hash_map<fir::Type*, fir::Type*>& subst)    { return this; }
	...
	fir::Type* RangeType::substitutePlaceholders(const ska::flat_hash_map<fir::Type*, fir::Type*>& subst)   { return this; }
	...
	fir::Type* StringType::substitutePlaceholders(const ska::flat_hash_map<fir::Type*, fir::Type*>& subst)  { return this; }
	...
	fir::Type* ConstantNumberType::substitutePlaceholders(const ska::flat_hash_map<fir::Type*, fir::Type*>& subst)
	{
		return this;
	}
	...
	static std::vector<ska::flat_hash_map<std::string, PolyPlaceholderType*>> cache;
	...
	static fir::Type* _substitute(const ska::flat_hash_map<fir::Type*, fir::Type*>& subst, fir::Type* t)
	{
	...
	fir::Type* PolyPlaceholderType::substitutePlaceholders(const ska::flat_hash_map<fir::Type*, fir::Type*>& subst)
	{

...
namespace fir
{
	...
	static ska::flat_hash_map<size_t, std::vector<PrimitiveType*>> primitiveTypeCache;
	...
	fir::Type* PrimitiveType::substitutePlaceholders(const ska::flat_hash_map<fir::Type*, fir::Type*>& subst)
	{
		return this;
	}
}

...
namespace poly
{
	...
	namespace internal
	{
		static std::pair<Solution_t, ErrorMsg*> inferPolymorphicType(TypecheckState* fs, ast::TypeDefn* td, const std::string& name,
			...
			fir::Type* type_infer, bool isFnCall, fir::Type* problem_infer, ska::flat_hash_map<std::string, size_t>* origParamOrder)
		{
			...
			{
				ska::flat_hash_map<std::string, size_t> paramOrder;
			...
			else if(auto str = dcast(ast::StructDefn, td))
			{
				...
				ska::flat_hash_map<std::string, size_t> fieldNames;
				{
					size_t i = 0;
		...
		std::pair<Solution_t, ErrorMsg*> inferTypesForPolymorph(TypecheckState* fs, ast::Parameterisable* thing, const std::string& name,
			...
			fir::Type* problem_infer, ska::flat_hash_map<std::string, size_t>* origParamOrder)
		{
